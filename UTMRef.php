 ...
 */
  ...
  class UTMRef {
    ...
    public function toLatLng() {
      ...
      $latitude = ($phi1Rad - ($n * tan($phi1Rad) / $r) * ($d * $d / 2 - (5 + (3 * $t) + (10 * $c) - (4 * $c * $c) - (9 * $ePrimeSquared)) * pow($d, 4) / 24 + (61 + (90 * $t) + (298 * $c) + (45 * $t * $t) - (252 * $ePrimeSquared) - (3 * $c * $c)) * pow($d, 6) / 720)) * (180 / pi());

      $longitude = $longitudeOrigin + (($d - (1 + 2 * $t + $c) * pow($d, 3) / 6 + (5 - (2 * $c) + (28 * $t) - (3 * $c * $c) + (8 * $ePrimeSquared) + (24 * $t * $t)) * pow($d, 5) / 120) / cos($phi1Rad)) * (180 / pi());
