...
class Vertical extends CoordinateSystem
{
    ...
    protected static array $sridData = [
        ...
        'urn:ogc:def:cs:EPSG::6498' => [
            'name' => 'Vertical CS. Axis: depth (D). Orientation: down. UoM: m.',
            'axes' => [
                [
                    'orientation' => 'down',
                    'abbreviation' => 'D',
        ...
        'urn:ogc:def:cs:EPSG::6495' => [
            'name' => 'Vertical CS. Axis: depth (D). Orientation: down. UoM: ft.',
            'axes' => [
                [
                    'orientation' => 'down',
                    'abbreviation' => 'D',
        ...
        'urn:ogc:def:cs:EPSG::6497' => [
            'name' => 'Vertical CS. Axis: height (H). Orientation: up. UoM: ftUS.',
            'axes' => [
                [
                    'orientation' => 'up',
                    'abbreviation' => 'H',
        ...
        'urn:ogc:def:cs:EPSG::6496' => [
            'name' => 'Vertical CS. Axis: height (H). Orientation: up. UoM: ft(Br36).',
            'axes' => [
                [
                    'orientation' => 'up',
                    'abbreviation' => 'H',
        ...
        'urn:ogc:def:cs:EPSG::1030' => [
            'name' => 'Vertical CS. Axis: height (H). Orientation: up. UoM: ft.',
            'axes' => [
                [
                    'orientation' => 'up',
                    'abbreviation' => 'H',
        ...
        'urn:ogc:def:cs:EPSG::1043' => [
            'name' => 'Vertical CS. Axis: depth (D). Orientation: down. UoM: ftUS.',
            'axes' => [
                [
                    'orientation' => 'down',
                    'abbreviation' => 'D',
