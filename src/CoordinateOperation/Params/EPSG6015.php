...
/** @internal */ return [
    ...
    'longitudeOfFalseOrigin' => UnitOfMeasureFactory::makeUnit(82.0, 'urn:ogc:def:uom:EPSG::9110'),
    ...
    'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(32500000.0, 'urn:ogc:def:uom:EPSG::9001'),
