...
/** @internal */ return [
    ...
    'falseEasting' => UnitOfMeasureFactory::makeUnit(836694.05, 'urn:ogc:def:uom:EPSG::9001'),
    'falseNorthing' => UnitOfMeasureFactory::makeUnit(819069.8, 'urn:ogc:def:uom:EPSG::9001'),
];
