...
/** @internal */ return [
    ...
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(1.5, 'urn:ogc:def:uom:EPSG::9001'),
    ...
    'zAxisRotation' => UnitOfMeasureFactory::makeUnit(-0.076, 'urn:ogc:def:uom:EPSG::9104'),
