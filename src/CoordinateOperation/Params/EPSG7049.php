...
/** @internal */ return [
  ...
  'longitudeOfNaturalOrigin' => UnitOfMeasureFactory::makeUnit(-94.38, 'urn:ogc:def:uom:EPSG::9110'),
  ...
  'falseNorthing' => UnitOfMeasureFactory::makeUnit(6800000.0, 'urn:ogc:def:uom:EPSG::9003'),
];
