...
/** @internal */ return [
    ...
    'longitudeOfNaturalOrigin' => UnitOfMeasureFactory::makeUnit(28.24, 'urn:ogc:def:uom:EPSG::9110'),
    'scaleFactorAtNaturalOrigin' => UnitOfMeasureFactory::makeUnit(0.99994, 'urn:ogc:def:uom:EPSG::9201'),
