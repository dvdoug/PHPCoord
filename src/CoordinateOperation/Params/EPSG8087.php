...
/** @internal */ return [
    ...
    'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(2700000.0, 'urn:ogc:def:uom:EPSG::9001'),
    'northingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(300000.0, 'urn:ogc:def:uom:EPSG::9001'),
];
