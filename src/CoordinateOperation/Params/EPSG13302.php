...
/** @internal */ return [
    ...
    'latitudeOf1stStandardParallel' => UnitOfMeasureFactory::makeUnit(46.11, 'urn:ogc:def:uom:EPSG::9110'),
    'latitudeOf2ndStandardParallel' => UnitOfMeasureFactory::makeUnit(47.29, 'urn:ogc:def:uom:EPSG::9110'),
