...
/** @internal */ return [
    'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(-2.4, 'urn:ogc:def:uom:EPSG::1025'),
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(1.6, 'urn:ogc:def:uom:EPSG::1025'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(23.2, 'urn:ogc:def:uom:EPSG::1025'),
    ...
    'scaleDifference' => UnitOfMeasureFactory::makeUnit(2.08, 'urn:ogc:def:uom:EPSG::1028'),
