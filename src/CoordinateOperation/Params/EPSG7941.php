...
/** @internal */ return [
    'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(54.0, 'urn:ogc:def:uom:EPSG::1025'),
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(51.0, 'urn:ogc:def:uom:EPSG::1025'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-48.0, 'urn:ogc:def:uom:EPSG::1025'),
