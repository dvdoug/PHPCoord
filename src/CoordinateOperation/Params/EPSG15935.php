...
/** @internal */ return [
    'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(18.0, 'urn:ogc:def:uom:EPSG::9001'),
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(-136.8, 'urn:ogc:def:uom:EPSG::9001'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-73.7, 'urn:ogc:def:uom:EPSG::9001'),
