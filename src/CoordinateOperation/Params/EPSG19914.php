...
/** @internal */ return [
    ...
    'falseEasting' => UnitOfMeasureFactory::makeUnit(155000.0, 'urn:ogc:def:uom:EPSG::9001'),
    'falseNorthing' => UnitOfMeasureFactory::makeUnit(463000.0, 'urn:ogc:def:uom:EPSG::9001'),
];
