...
/** @internal */ return [
  ...
  'falseEasting' => UnitOfMeasureFactory::makeUnit(157480.0, 'urn:ogc:def:uom:EPSG::9003'),
  'falseNorthing' => UnitOfMeasureFactory::makeUnit(78740.0, 'urn:ogc:def:uom:EPSG::9003'),
];
