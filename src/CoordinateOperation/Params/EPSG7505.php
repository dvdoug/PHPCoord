...
/** @internal */ return [
  ...
  'falseEasting' => UnitOfMeasureFactory::makeUnit(610000.003, 'urn:ogc:def:uom:EPSG::9003'),
  'falseNorthing' => UnitOfMeasureFactory::makeUnit(0.003, 'urn:ogc:def:uom:EPSG::9003'),
];
