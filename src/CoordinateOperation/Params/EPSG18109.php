...
/** @internal */ return [
  ...
  'latitudeOf1stStandardParallel' => [
    'reverses' => false,
    'value' => UnitOfMeasureFactory::makeUnit(49.25, 'urn:ogc:def:uom:EPSG::9102'),
  ],
  'latitudeOf2ndStandardParallel' => [
    'reverses' => false,
    'value' => UnitOfMeasureFactory::makeUnit(50.75, 'urn:ogc:def:uom:EPSG::9102'),
  ],
  ...
  'northingAtFalseOrigin' => [
    'reverses' => false,
    'value' => UnitOfMeasureFactory::makeUnit(9200000.0, 'urn:ogc:def:uom:EPSG::9001'),
  ],
];
