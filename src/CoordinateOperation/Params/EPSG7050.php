...
/** @internal */ return [
  ...
  'longitudeOfNaturalOrigin' => UnitOfMeasureFactory::makeUnit(-93.43, 'urn:ogc:def:uom:EPSG::9110'),
  ...
  'falseNorthing' => UnitOfMeasureFactory::makeUnit(7000000.0, 'urn:ogc:def:uom:EPSG::9003'),
];
