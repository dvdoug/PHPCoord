...
/** @internal */ return [
    ...
    'longitudeOfNaturalOrigin' => UnitOfMeasureFactory::makeUnit(121.53, 'urn:ogc:def:uom:EPSG::9110'),
    ...
    'falseNorthing' => UnitOfMeasureFactory::makeUnit(4050000.0, 'urn:ogc:def:uom:EPSG::9001'),
];
