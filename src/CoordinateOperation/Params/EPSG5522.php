...
/** @internal */ return [
    ...
    'longitudeOfNaturalOrigin' => UnitOfMeasureFactory::makeUnit(11.3, 'urn:ogc:def:uom:EPSG::9110'),
    ...
    'falseNorthing' => UnitOfMeasureFactory::makeUnit(5500000.0, 'urn:ogc:def:uom:EPSG::9001'),
];
