...
/** @internal */ return [
    'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(-24.5, 'urn:ogc:def:uom:EPSG::1025'),
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(3.9, 'urn:ogc:def:uom:EPSG::1025'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(169.9, 'urn:ogc:def:uom:EPSG::1025'),
    ...
    'scaleDifference' => UnitOfMeasureFactory::makeUnit(-11.47, 'urn:ogc:def:uom:EPSG::1028'),
