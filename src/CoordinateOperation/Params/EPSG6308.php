...
/** @internal */ return [
    ...
    'longitudeOfNaturalOrigin' => UnitOfMeasureFactory::makeUnit(33.0, 'urn:ogc:def:uom:EPSG::9102'),
    ...
    'falseNorthing' => UnitOfMeasureFactory::makeUnit(-3500000.0, 'urn:ogc:def:uom:EPSG::9001'),
];
