...
/** @internal */ return [
    ...
    'latitudeOf1stStandardParallel' => UnitOfMeasureFactory::makeUnit(42.06, 'urn:ogc:def:uom:EPSG::9110'),
    'latitudeOf2ndStandardParallel' => UnitOfMeasureFactory::makeUnit(43.4, 'urn:ogc:def:uom:EPSG::9110'),
