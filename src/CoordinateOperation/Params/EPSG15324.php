...
/** @internal */ return [
  ...
  'scaleFactorAtNaturalOrigin' => UnitOfMeasureFactory::makeUnit(0.999947368, 'urn:ogc:def:uom:EPSG::9201'),
  'falseEasting' => UnitOfMeasureFactory::makeUnit(1640416.667, 'urn:ogc:def:uom:EPSG::9003'),
