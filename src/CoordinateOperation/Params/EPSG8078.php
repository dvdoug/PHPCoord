...
/** @internal */ return [
    'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(-0.7, 'urn:ogc:def:uom:EPSG::1025'),
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(-1.2, 'urn:ogc:def:uom:EPSG::1025'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(26.1, 'urn:ogc:def:uom:EPSG::1025'),
