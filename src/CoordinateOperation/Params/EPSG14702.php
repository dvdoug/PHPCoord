...
/** @internal */ return [
    ...
    'latitudeOf1stStandardParallel' => UnitOfMeasureFactory::makeUnit(37.29, 'urn:ogc:def:uom:EPSG::9110'),
    'latitudeOf2ndStandardParallel' => UnitOfMeasureFactory::makeUnit(38.53, 'urn:ogc:def:uom:EPSG::9110'),
