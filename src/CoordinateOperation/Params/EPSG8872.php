...
/** @internal */ return [
  'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(-7.4, 'urn:ogc:def:uom:EPSG::1025'),
  'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(0.5, 'urn:ogc:def:uom:EPSG::1025'),
  'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(62.8, 'urn:ogc:def:uom:EPSG::1025'),
  ...
  'scaleDifference' => UnitOfMeasureFactory::makeUnit(-3.8, 'urn:ogc:def:uom:EPSG::1028'),
