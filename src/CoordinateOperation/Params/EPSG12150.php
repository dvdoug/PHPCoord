...
/** @internal */ return [
    ...
    'azimuthOfInitialLine' => UnitOfMeasureFactory::makeUnit(337.25556, 'urn:ogc:def:uom:EPSG::9102'),
    'angleFromRectifiedToSkewGrid' => UnitOfMeasureFactory::makeUnit(337.25556, 'urn:ogc:def:uom:EPSG::9102'),
    'scaleFactorOnInitialLine' => UnitOfMeasureFactory::makeUnit(0.9996, 'urn:ogc:def:uom:EPSG::9201'),
