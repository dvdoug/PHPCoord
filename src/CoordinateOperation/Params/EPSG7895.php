...
/** @internal */ return [
    'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(-112.854, 'urn:ogc:def:uom:EPSG::9001'),
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(12.27, 'urn:ogc:def:uom:EPSG::9001'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-18.913, 'urn:ogc:def:uom:EPSG::9001'),
