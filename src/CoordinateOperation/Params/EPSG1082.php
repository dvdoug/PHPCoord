...
/** @internal */ return [
  'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(174.05, 'urn:ogc:def:uom:EPSG::9001'),
  'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(-25.49, 'urn:ogc:def:uom:EPSG::9001'),
  'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(112.57, 'urn:ogc:def:uom:EPSG::9001'),
