...
/** @internal */ return [
  'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(27.3, 'urn:ogc:def:uom:EPSG::1025'),
  'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(30.7, 'urn:ogc:def:uom:EPSG::1025'),
  'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-11.3, 'urn:ogc:def:uom:EPSG::1025'),
  ...
  'scaleDifference' => UnitOfMeasureFactory::makeUnit(-2.27, 'urn:ogc:def:uom:EPSG::1028'),
