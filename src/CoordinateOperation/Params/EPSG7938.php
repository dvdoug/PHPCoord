...
/** @internal */ return [
  'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(4.1, 'urn:ogc:def:uom:EPSG::1033'),
  'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(4.1, 'urn:ogc:def:uom:EPSG::1033'),
  'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-4.9, 'urn:ogc:def:uom:EPSG::1033'),
  ...
  'rateOfChangeOfXAxisRotation' => UnitOfMeasureFactory::makeUnit(0.2, 'urn:ogc:def:uom:EPSG::1032'),
  'rateOfChangeOfYAxisRotation' => UnitOfMeasureFactory::makeUnit(0.5, 'urn:ogc:def:uom:EPSG::1032'),
  'rateOfChangeOfZAxisRotation' => UnitOfMeasureFactory::makeUnit(-0.65, 'urn:ogc:def:uom:EPSG::1032'),
