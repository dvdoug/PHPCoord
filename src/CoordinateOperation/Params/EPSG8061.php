...
/** @internal */ return [
  ...
  'azimuthOfInitialLine' => UnitOfMeasureFactory::makeUnit(45.0, 'urn:ogc:def:uom:EPSG::9102'),
  'angleFromRectifiedToSkewGrid' => UnitOfMeasureFactory::makeUnit(45.0, 'urn:ogc:def:uom:EPSG::9102'),
  'scaleFactorOnInitialLine' => UnitOfMeasureFactory::makeUnit(1.00011, 'urn:ogc:def:uom:EPSG::9201'),
