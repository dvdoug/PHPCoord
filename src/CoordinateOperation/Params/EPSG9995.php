...
/** @internal */ return [
  'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(-6.5, 'urn:ogc:def:uom:EPSG::1025'),
  'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(3.9, 'urn:ogc:def:uom:EPSG::1025'),
  'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(77.9, 'urn:ogc:def:uom:EPSG::1025'),
  ...
  'scaleDifference' => UnitOfMeasureFactory::makeUnit(-3.98, 'urn:ogc:def:uom:EPSG::1028'),
