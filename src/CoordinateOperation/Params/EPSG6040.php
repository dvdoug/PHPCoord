...
/** @internal */ return [
  ...
  'longitudeOfFalseOrigin' => UnitOfMeasureFactory::makeUnit(-147.0, 'urn:ogc:def:uom:EPSG::9110'),
  ...
  'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(16500000.0, 'urn:ogc:def:uom:EPSG::9001'),
