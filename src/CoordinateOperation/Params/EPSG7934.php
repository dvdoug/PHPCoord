...
/** @internal */ return [
    'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(2.1, 'urn:ogc:def:uom:EPSG::1033'),
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(2.5, 'urn:ogc:def:uom:EPSG::1033'),
