...
/** @internal */ return [
  ...
  'verticalOffset' => UnitOfMeasureFactory::makeUnit(0.028, 'urn:ogc:def:uom:EPSG::9001'),
  'inclinationInLatitude' => UnitOfMeasureFactory::makeUnit(0.002, 'urn:ogc:def:uom:EPSG::9104'),
