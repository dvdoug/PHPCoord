...
/** @internal */ return [
    ...
    'rateOfChangeOfXAxisTranslation' => UnitOfMeasureFactory::makeUnit(0.00743, 'urn:ogc:def:uom:EPSG::1042'),
    'rateOfChangeOfYAxisTranslation' => UnitOfMeasureFactory::makeUnit(0.00875, 'urn:ogc:def:uom:EPSG::1042'),
    'rateOfChangeOfZAxisTranslation' => UnitOfMeasureFactory::makeUnit(0.01402, 'urn:ogc:def:uom:EPSG::1042'),
