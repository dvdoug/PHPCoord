...
/** @internal */ return [
    ...
    'longitudeOfNaturalOrigin' => UnitOfMeasureFactory::makeUnit(-118.0, 'urn:ogc:def:uom:EPSG::9110'),
    'scaleFactorAtNaturalOrigin' => UnitOfMeasureFactory::makeUnit(1.00017, 'urn:ogc:def:uom:EPSG::9201'),
