...
/** @internal */ return [
  ...
  'falseEasting' => UnitOfMeasureFactory::makeUnit(371000.0, 'urn:ogc:def:uom:EPSG::9003'),
  'falseNorthing' => UnitOfMeasureFactory::makeUnit(0.015, 'urn:ogc:def:uom:EPSG::9003'),
];
