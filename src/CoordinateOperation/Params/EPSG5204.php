...
/** @internal */ return [
  ...
  'verticalOffset' => UnitOfMeasureFactory::makeUnit(0.121, 'urn:ogc:def:uom:EPSG::9001'),
  'inclinationInLatitude' => UnitOfMeasureFactory::makeUnit(0.053, 'urn:ogc:def:uom:EPSG::9104'),
