...
/** @internal */ return [
  ...
  'longitudeOfFalseOrigin' => UnitOfMeasureFactory::makeUnit(106.0, 'urn:ogc:def:uom:EPSG::9110'),
  ...
  'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(34500000.0, 'urn:ogc:def:uom:EPSG::9001'),
