...
/** @internal */ return [
    ...
    'verticalOffset' => UnitOfMeasureFactory::makeUnit(0.142, 'urn:ogc:def:uom:EPSG::9001'),
    'inclinationInLatitude' => UnitOfMeasureFactory::makeUnit(0.026, 'urn:ogc:def:uom:EPSG::9104'),
