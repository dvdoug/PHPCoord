...
/** @internal */ return [
    ...
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(-8.1, 'urn:ogc:def:uom:EPSG::1025'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(107.9, 'urn:ogc:def:uom:EPSG::1025'),
    ...
    'scaleDifference' => UnitOfMeasureFactory::makeUnit(-4.97, 'urn:ogc:def:uom:EPSG::1028'),
