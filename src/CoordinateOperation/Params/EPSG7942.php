...
/** @internal */ return [
  'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(24.3, 'urn:ogc:def:uom:EPSG::1025'),
  'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(10.7, 'urn:ogc:def:uom:EPSG::1025'),
  'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(42.7, 'urn:ogc:def:uom:EPSG::1025'),
  ...
  'scaleDifference' => UnitOfMeasureFactory::makeUnit(-5.97, 'urn:ogc:def:uom:EPSG::1028'),
