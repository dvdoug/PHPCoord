...
/** @internal */ return [
    ...
    'longitudeOfFalseOrigin' => UnitOfMeasureFactory::makeUnit(-56.0, 'urn:ogc:def:uom:EPSG::9110'),
    ...
    'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(26500000.0, 'urn:ogc:def:uom:EPSG::9001'),
