...
/** @internal */ return [
    ...
    'falseEasting' => UnitOfMeasureFactory::makeUnit(60045.72, 'urn:ogc:def:uom:EPSG::9001'),
    'falseNorthing' => UnitOfMeasureFactory::makeUnit(44091.4346, 'urn:ogc:def:uom:EPSG::9001'),
];
