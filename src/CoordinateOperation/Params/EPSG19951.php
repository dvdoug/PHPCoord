...
/** @internal */ return [
    ...
    'azimuthOfInitialLine' => UnitOfMeasureFactory::makeUnit(0.34179803, 'urn:ogc:def:uom:EPSG::9110'),
    'angleFromRectifiedToSkewGrid' => UnitOfMeasureFactory::makeUnit(0.34179803, 'urn:ogc:def:uom:EPSG::9110'),
    'scaleFactorOnInitialLine' => UnitOfMeasureFactory::makeUnit(0.999895934, 'urn:ogc:def:uom:EPSG::9201'),
