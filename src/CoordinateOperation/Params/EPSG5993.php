...
/** @internal */ return [
  ...
  'longitudeOfFalseOrigin' => UnitOfMeasureFactory::makeUnit(21.0, 'urn:ogc:def:uom:EPSG::9110'),
  ...
  'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(11500000.0, 'urn:ogc:def:uom:EPSG::9001'),
