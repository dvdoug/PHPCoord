...
/** @internal */ return [
    ...
    'latitudeOf1stStandardParallel' => UnitOfMeasureFactory::makeUnit(41.57, 'urn:ogc:def:uom:EPSG::9110'),
    'latitudeOf2ndStandardParallel' => UnitOfMeasureFactory::makeUnit(40.53, 'urn:ogc:def:uom:EPSG::9110'),
