...
/** @internal */ return [
    ...
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(154.8, 'urn:ogc:def:uom:EPSG::1025'),
    ...
    'scaleDifference' => UnitOfMeasureFactory::makeUnit(-11.29, 'urn:ogc:def:uom:EPSG::1028'),
