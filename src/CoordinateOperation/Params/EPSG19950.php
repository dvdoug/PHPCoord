...
/** @internal */ return [
    ...
    'eastingAtProjectionCentre' => UnitOfMeasureFactory::makeUnit(2600000.0, 'urn:ogc:def:uom:EPSG::9001'),
    'northingAtProjectionCentre' => UnitOfMeasureFactory::makeUnit(1200000.0, 'urn:ogc:def:uom:EPSG::9001'),
];
