...
/** @internal */ return [
    ...
    'longitudeOfFalseOrigin' => UnitOfMeasureFactory::makeUnit(114.0, 'urn:ogc:def:uom:EPSG::9110'),
    ...
    'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(17500000.0, 'urn:ogc:def:uom:EPSG::9001'),
