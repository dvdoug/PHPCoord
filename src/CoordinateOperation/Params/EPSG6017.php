...
/** @internal */ return [
    ...
    'longitudeOfFalseOrigin' => UnitOfMeasureFactory::makeUnit(130.0, 'urn:ogc:def:uom:EPSG::9110'),
    ...
    'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(36500000.0, 'urn:ogc:def:uom:EPSG::9001'),
