...
/** @internal */ return [
    ...
    'verticalOffset' => UnitOfMeasureFactory::makeUnit(-2.317, 'urn:ogc:def:uom:EPSG::9001'),
    'inclinationInLatitude' => UnitOfMeasureFactory::makeUnit(-0.031, 'urn:ogc:def:uom:EPSG::9104'),
