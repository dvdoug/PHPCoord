...
/** @internal */ return [
    ...
    'falseEasting' => UnitOfMeasureFactory::makeUnit(263347.7263, 'urn:ogc:def:uom:EPSG::9001'),
    'falseNorthing' => UnitOfMeasureFactory::makeUnit(0.0076, 'urn:ogc:def:uom:EPSG::9001'),
];
