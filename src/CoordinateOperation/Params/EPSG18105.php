...
/** @internal */ return [
  ...
  'latitudeOf1stStandardParallel' => [
    'reverses' => false,
    'value' => UnitOfMeasureFactory::makeUnit(45.25, 'urn:ogc:def:uom:EPSG::9102'),
  ],
  'latitudeOf2ndStandardParallel' => [
    'reverses' => false,
    'value' => UnitOfMeasureFactory::makeUnit(46.75, 'urn:ogc:def:uom:EPSG::9102'),
  ],
  ...
  'northingAtFalseOrigin' => [
    'reverses' => false,
    'value' => UnitOfMeasureFactory::makeUnit(5200000.0, 'urn:ogc:def:uom:EPSG::9001'),
  ],
];
