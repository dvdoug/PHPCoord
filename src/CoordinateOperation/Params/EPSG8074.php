...
/** @internal */ return [
  ...
  'xAxisRotation' => UnitOfMeasureFactory::makeUnit(2.81, 'urn:ogc:def:uom:EPSG::1031'),
  'yAxisRotation' => UnitOfMeasureFactory::makeUnit(3.38, 'urn:ogc:def:uom:EPSG::1031'),
  'zAxisRotation' => UnitOfMeasureFactory::makeUnit(-0.4, 'urn:ogc:def:uom:EPSG::1031'),
