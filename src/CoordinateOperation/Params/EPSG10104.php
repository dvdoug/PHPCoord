...
/** @internal */ return [
    'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(-29.5, 'urn:ogc:def:uom:EPSG::1025'),
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(-32.1, 'urn:ogc:def:uom:EPSG::1025'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(145.9, 'urn:ogc:def:uom:EPSG::1025'),
    ...
    'scaleDifference' => UnitOfMeasureFactory::makeUnit(-8.37, 'urn:ogc:def:uom:EPSG::1028'),
