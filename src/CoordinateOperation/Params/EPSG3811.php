...
/** @internal */ return [
  ...
  'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(649328.0, 'urn:ogc:def:uom:EPSG::9001'),
  'northingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(665262.0, 'urn:ogc:def:uom:EPSG::9001'),
];
