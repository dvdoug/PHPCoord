...
/** @internal */ return [
    ...
    'verticalOffset' => UnitOfMeasureFactory::makeUnit(0.182, 'urn:ogc:def:uom:EPSG::9001'),
    'inclinationInLatitude' => UnitOfMeasureFactory::makeUnit(0.001, 'urn:ogc:def:uom:EPSG::9104'),
    'inclinationInLongitude' => UnitOfMeasureFactory::makeUnit(-0.004, 'urn:ogc:def:uom:EPSG::9104'),
