...
/** @internal */ return [
    ...
    'falseEasting' => UnitOfMeasureFactory::makeUnit(146304.2926, 'urn:ogc:def:uom:EPSG::9001'),
    'falseNorthing' => UnitOfMeasureFactory::makeUnit(0.0068, 'urn:ogc:def:uom:EPSG::9001'),
];
