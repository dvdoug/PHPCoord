...
/** @internal */ return [
  'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(-30.4, 'urn:ogc:def:uom:EPSG::1025'),
  'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(-35.5, 'urn:ogc:def:uom:EPSG::1025'),
  'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(130.8, 'urn:ogc:def:uom:EPSG::1025'),
  ...
  'scaleDifference' => UnitOfMeasureFactory::makeUnit(-8.19, 'urn:ogc:def:uom:EPSG::1028'),
