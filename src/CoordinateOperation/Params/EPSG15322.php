...
/** @internal */ return [
    ...
    'longitudeOfNaturalOrigin' => UnitOfMeasureFactory::makeUnit(-84.1, 'urn:ogc:def:uom:EPSG::9110'),
    'scaleFactorAtNaturalOrigin' => UnitOfMeasureFactory::makeUnit(0.9999, 'urn:ogc:def:uom:EPSG::9201'),
    'falseEasting' => UnitOfMeasureFactory::makeUnit(2296583.333, 'urn:ogc:def:uom:EPSG::9003'),
