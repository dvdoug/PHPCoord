...
/** @internal */ return [
    ...
    'longitudeOfFalseOrigin' => UnitOfMeasureFactory::makeUnit(-91.0, 'urn:ogc:def:uom:EPSG::9110'),
    ...
    'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(37500000.0, 'urn:ogc:def:uom:EPSG::9001'),
