...
/** @internal */ return [
    ...
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(-103.0, 'urn:ogc:def:uom:EPSG::9001'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-122.5, 'urn:ogc:def:uom:EPSG::9001'),
