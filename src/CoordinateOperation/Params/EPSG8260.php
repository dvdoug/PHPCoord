...
/** @internal */ return [
    ...
    'scaleDifference' => UnitOfMeasureFactory::makeUnit(-0.935, 'urn:ogc:def:uom:EPSG::1028'),
    ...
    'rateOfChangeOfScaleDifference' => UnitOfMeasureFactory::makeUnit(-0.192, 'urn:ogc:def:uom:EPSG::1030'),
