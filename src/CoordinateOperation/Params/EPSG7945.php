...
/** @internal */ return [
  'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(39.3, 'urn:ogc:def:uom:EPSG::1025'),
  'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(44.7, 'urn:ogc:def:uom:EPSG::1025'),
  'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-17.3, 'urn:ogc:def:uom:EPSG::1025'),
  ...
  'scaleDifference' => UnitOfMeasureFactory::makeUnit(-0.87, 'urn:ogc:def:uom:EPSG::1028'),
