...
/** @internal */ return [
    ...
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(-1.90921, 'urn:ogc:def:uom:EPSG::9001'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-0.54157, 'urn:ogc:def:uom:EPSG::9001'),
    ...
    'scaleDifference' => UnitOfMeasureFactory::makeUnit(0.36891, 'urn:ogc:def:uom:EPSG::1028'),
    ...
    'rateOfChangeOfZAxisTranslation' => UnitOfMeasureFactory::makeUnit(-0.00144, 'urn:ogc:def:uom:EPSG::1042'),
