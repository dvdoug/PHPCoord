...
/** @internal */ return [
    ...
    'scaleFactorAtNaturalOrigin' => UnitOfMeasureFactory::makeUnit(0.9993, 'urn:ogc:def:uom:EPSG::9201'),
    'falseEasting' => UnitOfMeasureFactory::makeUnit(500000.0, 'urn:ogc:def:uom:EPSG::9001'),
    'falseNorthing' => UnitOfMeasureFactory::makeUnit(-5300000.0, 'urn:ogc:def:uom:EPSG::9001'),
];
