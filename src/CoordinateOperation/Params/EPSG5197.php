...
/** @internal */ return [
    ...
    'verticalOffset' => UnitOfMeasureFactory::makeUnit(-0.313, 'urn:ogc:def:uom:EPSG::9001'),
    'inclinationInLatitude' => UnitOfMeasureFactory::makeUnit(-0.016, 'urn:ogc:def:uom:EPSG::9104'),
    'inclinationInLongitude' => UnitOfMeasureFactory::makeUnit(-0.018, 'urn:ogc:def:uom:EPSG::9104'),
