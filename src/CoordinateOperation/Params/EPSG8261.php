...
/** @internal */ return [
    ...
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-0.5214, 'urn:ogc:def:uom:EPSG::9001'),
    ...
    'scaleDifference' => UnitOfMeasureFactory::makeUnit(0.615, 'urn:ogc:def:uom:EPSG::1028'),
    ...
    'rateOfChangeOfScaleDifference' => UnitOfMeasureFactory::makeUnit(-0.182, 'urn:ogc:def:uom:EPSG::1030'),
