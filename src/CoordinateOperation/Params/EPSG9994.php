...
/** @internal */ return [
  ...
  'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(-0.8, 'urn:ogc:def:uom:EPSG::1025'),
  'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(34.2, 'urn:ogc:def:uom:EPSG::1025'),
