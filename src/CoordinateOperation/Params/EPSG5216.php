...
/** @internal */ return [
    ...
    'verticalOffset' => UnitOfMeasureFactory::makeUnit(-0.402, 'urn:ogc:def:uom:EPSG::9001'),
    'inclinationInLatitude' => UnitOfMeasureFactory::makeUnit(-0.079, 'urn:ogc:def:uom:EPSG::9104'),
