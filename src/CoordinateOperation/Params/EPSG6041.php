...
/** @internal */ return [
  ...
  'longitudeOfFalseOrigin' => UnitOfMeasureFactory::makeUnit(-132.0, 'urn:ogc:def:uom:EPSG::9110'),
  ...
  'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(18500000.0, 'urn:ogc:def:uom:EPSG::9001'),
