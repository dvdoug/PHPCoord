...
/** @internal */ return [
  ...
  'longitudeOfFalseOrigin' => UnitOfMeasureFactory::makeUnit(-131.0, 'urn:ogc:def:uom:EPSG::9110'),
  ...
  'eastingAtFalseOrigin' => UnitOfMeasureFactory::makeUnit(33500000.0, 'urn:ogc:def:uom:EPSG::9001'),
