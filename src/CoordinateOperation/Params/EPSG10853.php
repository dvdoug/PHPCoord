...
/** @internal */ return [
    ...
    'rateOfChangeOfXAxisRotation' => UnitOfMeasureFactory::makeUnit(1.3242, 'urn:ogc:def:uom:EPSG::1032'),
    'rateOfChangeOfYAxisRotation' => UnitOfMeasureFactory::makeUnit(1.2788, 'urn:ogc:def:uom:EPSG::1032'),
    'rateOfChangeOfZAxisRotation' => UnitOfMeasureFactory::makeUnit(1.1675, 'urn:ogc:def:uom:EPSG::1032'),
