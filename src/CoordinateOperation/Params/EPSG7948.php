...
/** @internal */ return [
    'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(47.3, 'urn:ogc:def:uom:EPSG::1025'),
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(46.7, 'urn:ogc:def:uom:EPSG::1025'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-25.3, 'urn:ogc:def:uom:EPSG::1025'),
    ...
    'scaleDifference' => UnitOfMeasureFactory::makeUnit(-1.58, 'urn:ogc:def:uom:EPSG::1028'),
