...
/** @internal */ return [
    'xAxisTranslation' => UnitOfMeasureFactory::makeUnit(0.9963, 'urn:ogc:def:uom:EPSG::9001'),
    'yAxisTranslation' => UnitOfMeasureFactory::makeUnit(-1.9024, 'urn:ogc:def:uom:EPSG::9001'),
    'zAxisTranslation' => UnitOfMeasureFactory::makeUnit(-0.5219, 'urn:ogc:def:uom:EPSG::9001'),
    ...
    'scaleDifference' => UnitOfMeasureFactory::makeUnit(0.775, 'urn:ogc:def:uom:EPSG::1028'),
    'rateOfChangeOfXAxisTranslation' => UnitOfMeasureFactory::makeUnit(0.0005, 'urn:ogc:def:uom:EPSG::1042'),
    'rateOfChangeOfYAxisTranslation' => UnitOfMeasureFactory::makeUnit(-0.0006, 'urn:ogc:def:uom:EPSG::1042'),
    'rateOfChangeOfZAxisTranslation' => UnitOfMeasureFactory::makeUnit(-0.0013, 'urn:ogc:def:uom:EPSG::1042'),
