...
class GeocentricPointTest extends TestCase
{
    ...
    {
        $object = GeocentricPoint::create(new Metre(123), new Metre(456), new Metre(789), CoordinateReferenceSystem::fromEPSGCode(CoordinateReferenceSystem::EPSG_GEOCENTRIC_WGS_84));
    ...
    {
        $object = GeocentricPoint::create(UnitOfMeasureFactory::makeUnit(123, UnitOfMeasure::EPSG_LENGTH_FOOT), UnitOfMeasureFactory::makeUnit(123, UnitOfMeasure::EPSG_LENGTH_FOOT), UnitOfMeasureFactory::makeUnit(123, UnitOfMeasure::EPSG_LENGTH_FOOT), CoordinateReferenceSystem::fromEPSGCode(CoordinateReferenceSystem::EPSG_GEOCENTRIC_WGS_84));
    ...
    {
        $from = GeocentricPoint::create(new Metre(12300), new Metre(45600), new Metre(78900), CoordinateReferenceSystem::fromEPSGCode(CoordinateReferenceSystem::EPSG_GEOCENTRIC_WGS_84));
        $to = GeocentricPoint::create(new Metre(24600), new Metre(80200), new Metre(16800), CoordinateReferenceSystem::fromEPSGCode(CoordinateReferenceSystem::EPSG_GEOCENTRIC_WGS_84));
