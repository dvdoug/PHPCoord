...
class ProjectedPointTest extends TestCase
{
    ...
    {
        $object = ProjectedPoint::createFromEastingNorthing(new Metre(123), new Metre(456), CoordinateReferenceSystem::fromSRID(Projected::EPSG_WGS_84_WORLD_MERCATOR));
    ...
    {
        $object = ProjectedPoint::createFromEastingNorthing(new Metre(123), new Metre(456), CoordinateReferenceSystem::fromSRID(Projected::EPSG_WGS_84_WORLD_MERCATOR), new DateTime('2003-02-01'));
        self::assertEquals(123, $object->getEasting()->getValue());
        self::assertEquals(456, $object->getNorthing()->getValue());
        self::assertEquals('urn:ogc:def:crs:EPSG::3395', $object->getCRS()->getSrid());
    ...
    {
        $object = ProjectedPoint::createFromEastingNorthing(new Metre(123), new Metre(456), CoordinateReferenceSystem::fromSRID(Projected::EPSG_WGS_84_WORLD_MERCATOR), new DateTimeImmutable('2003-02-01'));
        self::assertEquals(123, $object->getEasting()->getValue());
        self::assertEquals(456, $object->getNorthing()->getValue());
        self::assertEquals('urn:ogc:def:crs:EPSG::3395', $object->getCRS()->getSrid());
        self::assertEquals('2003-02-01', $object->getCoordinateEpoch()->format('Y-m-d'));
    ...
    {
        $object = ProjectedPoint::createFromEastingNorthing(UnitOfMeasureFactory::makeUnit(123, UnitOfMeasure::EPSG_LENGTH_FOOT), UnitOfMeasureFactory::makeUnit(123, UnitOfMeasure::EPSG_LENGTH_FOOT), CoordinateReferenceSystem::fromSRID(Projected::EPSG_WGS_84_WORLD_MERCATOR));
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(438700), new Metre(114800), CoordinateReferenceSystem::fromSRID(Projected::EPSG_WGS_84_WORLD_MERCATOR));
        $to = ProjectedPoint::createFromEastingNorthing(new Metre(533600), new Metre(180500), CoordinateReferenceSystem::fromSRID(Projected::EPSG_WGS_84_WORLD_MERCATOR));
    ...
    public function testDistanceDifferentCRSEastingNorthing(): void
    {
        ...
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(438700), new Metre(114800), CoordinateReferenceSystem::fromSRID(Projected::EPSG_WGS_84_WORLD_MERCATOR));
        $to = ProjectedPoint::createFromEastingNorthing(new Metre(533600), new Metre(180500), CoordinateReferenceSystem::fromSRID(Projected::EPSG_OSGB_1936_BRITISH_NATIONAL_GRID));
        $from->calculateDistance($to);
    }

    public function testWestingNorthing(): void
    {
        $object = ProjectedPoint::createFromWestingNorthing(new Metre(123), new Metre(456), CoordinateReferenceSystem::fromSRID(Projected::EPSG_ETRS89_FAROE_LAMBERT));
    ...
    {
        $object = ProjectedPoint::createFromWestingNorthing(UnitOfMeasureFactory::makeUnit(123, UnitOfMeasure::EPSG_LENGTH_FOOT), UnitOfMeasureFactory::makeUnit(123, UnitOfMeasure::EPSG_LENGTH_FOOT), CoordinateReferenceSystem::fromSRID(Projected::EPSG_ETRS89_FAROE_LAMBERT));
    ...
    {
        $from = ProjectedPoint::createFromWestingNorthing(new Metre(438700), new Metre(114800), CoordinateReferenceSystem::fromSRID(Projected::EPSG_ETRS89_FAROE_LAMBERT));
        $to = ProjectedPoint::createFromWestingNorthing(new Metre(533600), new Metre(180500), CoordinateReferenceSystem::fromSRID(Projected::EPSG_ETRS89_FAROE_LAMBERT));
        self::assertEqualsWithDelta(115423.134596, $from->calculateDistance($to)->getValue(), 0.000001);
    }
    ...
    {
        $object = ProjectedPoint::createFromWestingSouthing(new Metre(123), new Metre(456), CoordinateReferenceSystem::fromSRID(Projected::EPSG_ST_STEPHEN_GRID_FERRO));
        self::assertEquals(123, $object->getWesting()->getValue());
    ...
    {
        $object = ProjectedPoint::createFromWestingSouthing(UnitOfMeasureFactory::makeUnit(123, UnitOfMeasure::EPSG_LENGTH_FOOT), UnitOfMeasureFactory::makeUnit(123, UnitOfMeasure::EPSG_LENGTH_FOOT), CoordinateReferenceSystem::fromSRID(Projected::EPSG_ST_STEPHEN_GRID_FERRO));
        self::assertEquals(37.4904, $object->getWesting()->getValue());
    ...
    {
        $from = ProjectedPoint::createFromWestingSouthing(new Metre(438700), new Metre(114800), CoordinateReferenceSystem::fromSRID(Projected::EPSG_ST_STEPHEN_GRID_FERRO));
        $to = ProjectedPoint::createFromWestingSouthing(new Metre(533600), new Metre(180500), CoordinateReferenceSystem::fromSRID(Projected::EPSG_ST_STEPHEN_GRID_FERRO));
        self::assertEqualsWithDelta(115423.134596, $from->calculateDistance($to)->getValue(), 0.000001);
    }
    ...
    {
        $from = ProjectedPoint::create(UnitOfMeasureFactory::makeUnit(553900, UnitOfMeasure::EPSG_LENGTH_CLARKE_S_FOOT), UnitOfMeasureFactory::makeUnit(482500, UnitOfMeasure::EPSG_LENGTH_CLARKE_S_FOOT), null, null, CoordinateReferenceSystem::fromSRID(Projected::EPSG_JAMAICA_1875_JAMAICA_OLD_GRID));
        $to = $from->affineParametricTransform(CoordinateReferenceSystem::fromSRID(Projected::EPSG_JAD69_JAMAICA_NATIONAL_GRID), new Metre(82357.457), new Coefficient(0.304794369), new Coefficient(0.000015417425), new Metre(28091.324), new Coefficient(-0.000015417425), new Coefficient(0.304794369), false);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(1466493.492), new Metre(702903.006), CoordinateReferenceSystem::fromSRID(Projected::EPSG_NAD83_GREAT_LAKES_ALBERS));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_NAD83);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(1408623.196), new Metre(1507641.482), CoordinateReferenceSystem::fromSRID(Projected::EPSG_TWD67_TM2_ZONE_119));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_TWD67);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(1776784.5), new Metre(1319677.8), CoordinateReferenceSystem::fromSRID(Projected::EPSG_NAD27_ALABAMA_EAST));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_NAD27);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(-962905.1), new Metre(-1056045.0), CoordinateReferenceSystem::fromSRID(Projected::EPSG_NAD27_ALABAMA_EAST));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_NAD27);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(-962925.1), new Metre(-1056085.0), CoordinateReferenceSystem::fromSRID(Projected::EPSG_NAD27_ALABAMA_EAST));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_NAD27);
    ...
    {
        $from = ProjectedPoint::create(new Metre(100), new Metre(200), null, null, CoordinateReferenceSystem::fromSRID(Projected::EPSG_JAMAICA_1875_JAMAICA_OLD_GRID));
        $to = $from->offsets(CoordinateReferenceSystem::fromSRID(Projected::EPSG_JAD69_JAMAICA_NATIONAL_GRID), new Metre(40), new Metre(60));
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(UnitOfMeasureFactory::makeUnit(66644.94, UnitOfMeasure::EPSG_LENGTH_CLARKE_S_LINK), UnitOfMeasureFactory::makeUnit(82536.22, UnitOfMeasure::EPSG_LENGTH_CLARKE_S_LINK), CoordinateReferenceSystem::fromSRID(Projected::EPSG_TRINIDAD_1903_TRINIDAD_GRID));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_TRINIDAD_1903);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(80859.033), new Metre(122543.174), CoordinateReferenceSystem::fromSRID(Projected::EPSG_MAGNA_SIRGAS_BOGOTA_URBAN_GRID));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_MAGNA_SIRGAS);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(-2390749.042), new Metre(4242849.758), CoordinateReferenceSystem::fromSRID(Projected::EPSG_WGS_84_EQUAL_EARTH_AMERICAS));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_WGS_84);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(1113194.91), new Metre(6097230.31), CoordinateReferenceSystem::fromSRID(Projected::EPSG_WGS_84_WORLD_EQUIDISTANT_CYLINDRICAL));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_WGS_84);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(37712.48), new Metre(35242.00), CoordinateReferenceSystem::fromSRID(Projected::EPSG_GUAM_1963_GUAM_SPCS));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_GUAM_1963);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(UnitOfMeasureFactory::makeUnit(1601528.9, UnitOfMeasure::EPSG_LENGTH_LINK), UnitOfMeasureFactory::makeUnit(1336966.6, UnitOfMeasure::EPSG_LENGTH_LINK), CoordinateReferenceSystem::fromSRID(Projected::EPSG_VANUA_LEVU_1915_VANUA_LEVU_GRID));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_VANUA_LEVU_1915);
    ...
    {
        $from = ProjectedPoint::createFromWestingSouthing(new Metre(568991.00), new Metre(1050538.64), CoordinateReferenceSystem::fromSRID(Projected::EPSG_S_JTSK_FERRO_KROVAK));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_S_JTSK);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(-568991.00), new Metre(-1050538.64), CoordinateReferenceSystem::fromSRID(Projected::EPSG_S_JTSK_FERRO_KROVAK_EAST_NORTH));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_S_JTSK);
        $to = $from->krovak($toCRS, new Radian(0.863937979), new Radian(0.741764932), new Radian(0.528627763), new Radian(1.370083463), new Coefficient(0.9999), new Metre(0), new Metre(0));
    ...
    {
        $from = ProjectedPoint::createFromWestingSouthing(new Metre(5568990.91), new Metre(6050538.71), CoordinateReferenceSystem::fromSRID(Projected::EPSG_S_JTSK_05_FERRO_MODIFIED_KROVAK));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_S_JTSK_05);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(-5568990.91), new Metre(-6050538.71), CoordinateReferenceSystem::fromSRID(Projected::EPSG_S_JTSK_05_FERRO_MODIFIED_KROVAK_EAST_NORTH));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_S_JTSK_05);
        $to = $from->krovakModified($toCRS, new Radian(0.863937979), new Radian(0.741764932), new Radian(0.528627763), new Radian(1.370083463), new Coefficient(0.9999), new Metre(5000000), new Metre(5000000), new Metre(1089000), new Metre(654000), new Coefficient(2.946529277E-02), new Coefficient(2.515965696E-02), new Coefficient(1.193845912E-07), new Coefficient(-4.668270147E-07), new Coefficient(9.233980362E-12), new Coefficient(1.523735715E-12), new Coefficient(1.696780024E-18), new Coefficient(4.408314235E-18), new Coefficient(-8.331083518E-24), new Coefficient(-3.689471323E-24));
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(3962799.45), new Metre(2999718.85), CoordinateReferenceSystem::fromSRID(Projected::EPSG_ETRS89_EXTENDED_LAEA_EUROPE));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_ETRS89);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(255966.59), new Metre(142493.51), CoordinateReferenceSystem::fromSRID(Projected::EPSG_JAD69_JAMAICA_NATIONAL_GRID));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_JAD69);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(UnitOfMeasureFactory::makeUnit(2963503.95, UnitOfMeasure::EPSG_LENGTH_US_SURVEY_FOOT), UnitOfMeasureFactory::makeUnit(254759.84, UnitOfMeasure::EPSG_LENGTH_US_SURVEY_FOOT), CoordinateReferenceSystem::fromSRID(Projected::EPSG_NAD27_TEXAS_SOUTH_CENTRAL));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_NAD27);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(UnitOfMeasureFactory::makeUnit(2308335.75, UnitOfMeasure::EPSG_LENGTH_US_SURVEY_FOOT), UnitOfMeasureFactory::makeUnit(160210.49, UnitOfMeasure::EPSG_LENGTH_US_SURVEY_FOOT), CoordinateReferenceSystem::fromSRID(Projected::EPSG_NAD27_MICHIGAN_CENTRAL));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_NAD27);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(251763.20), new Metre(153034.10), CoordinateReferenceSystem::fromSRID(Projected::EPSG_BELGE_1972_BELGE_LAMBERT_72));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_BELGE_1972);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(15707.96), new Metre(623165.96), CoordinateReferenceSystem::fromSRID(Projected::EPSG_DEIR_EZ_ZOR_LEVANT_ZONE));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_DEIR_EZ_ZOR);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(-332699.8), new Metre(1104391.2), CoordinateReferenceSystem::fromSRID(Projected::EPSG_DEIR_EZ_ZOR_LEVANT_ZONE));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_DEIR_EZ_ZOR);
    ...
    {
        $from = ProjectedPoint::createFromEastingNorthing(new Metre(42665.90), new Metre(65509.82), CoordinateReferenceSystem::fromSRID(Projected::EPSG_GUAM_1963_YAP_ISLANDS));
        $toCRS = CoordinateReferenceSystem::fromSRID(Geographic2D::EPSG_GUAM_1963);
